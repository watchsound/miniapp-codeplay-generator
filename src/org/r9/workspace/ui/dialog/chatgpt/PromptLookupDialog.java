...
public class PromptLookupDialog extends JDialog
    ...
    public PromptLookupDialog(Frame aFrame ,  final PromptLookupPanel.Callback callback) {
        super(aFrame, true);
      
        btnString1 =  "close" ;//"保存"; 
         
        PromptLookupPanel cpanel = new  PromptLookupPanel(   callback);
